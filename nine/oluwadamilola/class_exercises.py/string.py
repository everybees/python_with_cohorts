...
name_with_white_space_rstriped = name_with_white_space.rstrip()
name_with_white_space_rlstriped = name_with_white_space.strip()
...
for i in range(len(list_of_names_in_cohort9)):
    ...
    if len(list_of_names_in_cohort9[i]) == 5:
        ...
        print(f'The names with five letter words  and their index in the list are{i,five_letter_name}')
